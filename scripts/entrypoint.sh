...
echo "== Tienda Eaciot: aplicar contenido SEO pre-generado (offline, idempotente) =="
python scripts/apply_enriched_content.py 2>&1 | tee -a "$AUDIT" | python scripts/release_audit.py enrich_local || true
